	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>Manage <b>Employers</b></h2>
					</div>
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Employer</span></a>						
					</div>
				</div>
			</div>
			<table class="table table-striped table-hover">
				...
				<c:forEach items="${emplist}" var="o">
					<tr>
				            ...
				            <td><c:out value="${o.company}" /></td>
				            <td><c:out value="${o.city}" /></td>
				            <td><c:out value="${o.location}" /></td>
				            <td><c:out value="${o.job}" /></td>
				            
						<td>
							 <a href="#editEmployeeModal" class="edit" data-toggle="modal"
       onclick="setEditValues('${o.id}', '${o.name}', '${o.email}', '${o.pass}', '${o.mobile}', '${o.company}', '${o.city}', '${o.location}', '${o.job}')">
...
<div id="addEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="empcrudadd" method="post">
...
<div id="editEmployeeModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="empcrudupdate" method="post">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Password</label>
                        <input name="pass" id="editPass" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Phone</label>
                    ...
                    <div class="form-group">
                        <label>Company</label>
                        <input name="company" id="editCompany" type="text" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>City</label>
                        <input name="city" id="editCity" type="text" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Location</label>
                        <input name="location" id="editLocation" type="text" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Job</label>
                        <input name="job" id="editJob" type="text" class="form-control" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
...
<div id="deleteEmployeeModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="deleteForm" action="empcruddelete" method="post">
                <input type="hidden" id="deleteId" name="deleteId" value="">
                <div class="modal-header">                        
                    <h4 class="modal-title">Delete Employer</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                </div>
                <div class="modal-body">                    
...
<script>
    function setEditValues(id, name, email, pass, mobile, company, city, location, job) {

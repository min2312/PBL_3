	...
	<div class="table-responsive">
		<div class="table-wrapper">
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
				<c:forEach items="${adminlist}" var="o">
					<tr>
       ...
       onclick="setEditValues('${o.id}', '${o.name}', '${o.email}', '${o.pass}')">
...
<div id="addEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="admincrudadd" method="post">
...
<div id="editEmployeeModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="admincrudupdate" method="post">
                <div class="modal-header">
...
<div id="deleteEmployeeModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="deleteForm" action="admincruddelete" method="post">
...
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
	...
	if(status=="inuse")
	{
	swal("Deletion is blocked","The account you are trying to delete is in use","error");
	}
	</script>
<script>
...
<script>
    function setEditValues(id, name, email, pass) {

...
/**
 * Servlet implementation class ViewDetailControl
 */
@WebServlet(name = "ViewDetailControl", urlPatterns = {"/viewdetail"})
public class ViewDetailControl extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ViewDetailControl() {
        super();
